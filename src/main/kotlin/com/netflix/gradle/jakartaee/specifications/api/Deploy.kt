...
internal class Deploy : BasicApi(
    ...
    companion object {
        ...
        private val SPECIFICATION_TO_DEPLOY_VERSION = mapOf(
            SpecificationVersion.EE7 to ArtifactVersion("1.6.0"),
            SpecificationVersion.EE8 to ArtifactVersion("1.7.0"),
            // Optional APIs removed from the BOM for 9.0.0 and later, use last released version
            SpecificationVersion.EE9 to ArtifactVersion("1.7.2"),
            SpecificationVersion.EE9_1 to ArtifactVersion("1.7.2"),
            SpecificationVersion.EE10 to ArtifactVersion("1.7.2"),
        )
