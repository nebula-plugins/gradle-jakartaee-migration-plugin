...
- [Capabilities](https://docs.gradle.org/current/userguide/component_capabilities.html) causes the API artifacts of the EE specification to conflicts
- [Capabilities resolution](https://docs.gradle.org/current/userguide/dependency_capability_conflict.html) resolves conflicts by selecting the artifact providing the highest specification version:
